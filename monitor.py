    ...
    if os.getenv("TEST_EMAIL", "").strip().lower() in ("1", "true", "yes"):
        ...
        try:
            send_email(
                ...
                (
                    "Hello,\n\n"
                    "You've been added to the CPUC Meeting Monitor. This message "
                    "confirms that alerts are being delivered to you — no action "
                    "is needed.\n\n"
                    "WHAT THIS IS\n"
                    "The CPUC Meeting Monitor automatically watches the "
                    "California Public Utilities Commission (CPUC) and will alert "
                    "you when key documents are published on the Charter "
                    "Communications / Cox merger (CPUC proceeding A2507016).\n\n"
                    "WHAT YOU'LL RECEIVE\n\n"
                    "1. Voting Meeting Agenda\n"
                    "Sent when the agenda for an upcoming CPUC voting meeting is "
                    "published (usually about 10 days before the meeting). The "
                    "agenda is the list of items the Commissioners will vote on. "
                    "This alert also tells you whether the Charter/Cox merger "
                    "(A2507016) appears on that agenda.\n\n"
                    "2. Hold List\n"
                    "Sent when the meeting's Hold List is published — items that "
                    "were scheduled for a vote but have been postponed to a "
                    "later meeting.\n\n"
                    "3. Proposed Decision\n"
                    "Sent when a Proposed Decision is issued in the Charter/Cox "
                    "merger (A2507016). A Proposed Decision is the assigned "
                    "Administrative Law Judge's (ALJ's) recommended outcome, "
                    "published for public comment before the Commissioners vote.\n"
                    "This alert will also include a plain-language \"What Happens "
                    "Next\" timeline: the public comment period, the reply-"
                    "comment period, the earliest date the commission vote can be "
                    "placed on a voting agenda, and which upcoming voting meeting "
                    "is realistically possible.\n\n"
                    "WHAT EACH ALERT INCLUDES\n"
                    "  - The document title\n"
                    "  - The date the CPUC posted it\n"
                    "  - A direct link to the PDF\n"
                    "  - The date and time the monitor detected it (Pacific "
                    "Time)\n\n"
                    "You don't need to do anything — alerts arrive automatically "
                    "as documents are published.\n"
                ),
                config,
                html_body=(
                    "<p>Hello,</p>"
                    "<p>You've been added to the <b>CPUC Meeting Monitor</b>. "
                    "This message confirms that alerts are being delivered to "
                    "you — no action is needed.</p>"
                    "<p><u>WHAT THIS IS</u></p>"
                    "<p>The CPUC Meeting Monitor automatically watches the "
                    "<b>California Public Utilities Commission (CPUC)</b> and "
                    "will alert you when key documents are published on the "
                    "<b>Charter Communications / Cox merger</b> (CPUC proceeding "
                    "A2507016).</p>"
                    "<p><u>WHAT YOU'LL RECEIVE</u></p>"
                    "<p><b>1. Voting Meeting Agenda</b><br>"
                    "Sent when the agenda for an upcoming CPUC voting meeting is "
                    "published (usually about 10 days before the meeting). The "
                    "agenda is the list of items the Commissioners will vote on. "
                    "This alert also tells you whether the Charter/Cox merger "
                    "(A2507016) appears on that agenda.</p>"
                    "<p><b>2. Hold List</b><br>"
                    "Sent when the meeting's Hold List is published — items that "
                    "were scheduled for a vote but have been postponed to a "
                    "later meeting.</p>"
                    "<p><b>3. Proposed Decision</b><br>"
                    "Sent when a Proposed Decision is issued in the Charter/Cox "
                    "merger (A2507016). A Proposed Decision is the assigned "
                    "Administrative Law Judge's (ALJ's) recommended outcome, "
                    "published for public comment before the Commissioners "
                    "vote.<br>"
                    "This alert will also include a plain-language <b>\"What "
                    "Happens Next\"</b> timeline: the public comment period, the "
                    "reply-comment period, the earliest date the commission vote "
                    "can be placed on a voting agenda, and which upcoming voting "
                    "meeting is realistically possible.</p>"
                    "<p><u>WHAT EACH ALERT INCLUDES</u></p>"
                    "<ul style='margin:10px 0;padding-left:22px'>"
                    "<li style='margin-bottom:7px;line-height:1.45'>The document "
                    "title</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>The date the "
                    "CPUC posted it</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>A direct link "
                    "to the PDF</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>The date and "
                    "time the monitor detected it (Pacific Time)</li>"
                    "</ul>"
                    "<p>You don't need to do anything — alerts arrive "
                    "automatically as documents are published.</p>"
                ),
        ...
        try:
            send_email(
                ...
                (
                    ...
                    "issues a Proposed Decision first.\n"
                    "This Proposed Decision document is the earliest and most "
                    "critical signal of when a vote can actually take place. The "
                    "CPUC monitor now watches for it.\n\n"
                    "New: ALJ Proposed Decision Alert\n"
                    "When the ALJ issues a Proposed Decision in A2507016, you "
                    "will receive an alert and a timeline analysis based on the "
                    "decision itself.\n\n"
                    "Included in the alert will be the following:\n"
                    "  - What the mandatory post-decision public comment period "
                    "is — standard is 20 days but the ALJ has discretion to "
                    "reduce it (and likely will)\n"
                    "  - Whether reply comments are waived — the ALJ can waive "
                    "the customary 5 day reply period\n"
                    "  - The earliest date A2507016 can be placed on a voting "
                    "meeting agenda based on the comment windows\n"
                    "  - Whether the August 13 or September 3 voting meeting is "
                    "realistically viable\n\n"
                    "Note a commissioner can propose an \"Alternate Proposed "
                    "Decision\" to the ALJ decision and you will receive an alert "
                    "should this happen. This will generally not affect the "
                    "timeline and only means the Commission will now be voting to "
                    "approve the ALJ or Alternate decision. However, if the "
                    "Alternate Proposed Decision is filed less than 14 days "
                    "before a voting meeting, the vote gets automatically "
                    "rescheduled to a later meeting. Very unlikely to happen, but "
                    "it could complicate the plot further in this telenovela.\n\n"
                    "Updated: Agenda Alerts Now Identify the Merger\n"
                    "When a voting meeting agenda is published, your alert will "
                    "now explicitly indicate whether A2507016 appears on it.\n\n"
                    "The ALJ decision and comment window is key. A decision would "
                    "have to come in the next 2-3 weeks to make the agenda for "
                    "the August meeting. If not, it will come down to the "
                    "September meeting — a sudden death scenario given the DOJ "
                    "antitrust clearance deadline is September 15.\n\n"
                ...
                html_body=(
                    ...
                    "<b>Administrative Law Judge (ALJ)</b> issues a "
                    "<u><b>Proposed Decision first</b></u>. This Proposed "
                    "Decision document is the "
                    "earliest and most critical signal of when a vote can "
                    "actually take place. The CPUC monitor now watches for "
                    "it.</p>"
                    "<p><b>New: ALJ Proposed Decision Alert</b><br>"
                    "When the ALJ issues a Proposed Decision in A2507016, you "
                    "will receive an alert and a timeline analysis based on the "
                    "decision itself.</p>"
                    "<p>Included in the alert will be the following:</p>"
                    "<ul style='margin:10px 0;padding-left:22px'>"
                    "<li style='margin-bottom:7px;line-height:1.45'>What the "
                    "mandatory post-decision public comment period is — standard "
                    "is 20 days but the ALJ has discretion to reduce it (and "
                    "likely will)</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>Whether reply "
                    "comments are waived — the ALJ can waive the customary 5 day "
                    "reply period</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>The earliest "
                    "date A2507016 can be placed on a voting meeting agenda based "
                    "on the comment windows</li>"
                    "<li style='margin-bottom:7px;line-height:1.45'>Whether the "
                    "August 13 or September 3 voting meeting is realistically "
                    "viable</li>"
                    "</ul>"
                    "<p style='font-style:italic'>Note a commissioner can "
                    "propose an <b>\"Alternate Proposed Decision\"</b> to the "
                    "ALJ decision and you will "
                    "receive an alert should this happen. This will generally not "
                    "affect the timeline and only means the Commission will now "
                    "be voting to approve the ALJ or Alternate decision. However, "
                    "if the Alternate Proposed Decision is filed <b>less than 14 "
                    "days before a voting meeting</b>, the vote gets "
                    "automatically rescheduled to a later meeting. Very unlikely "
                    "to happen, but it could complicate the plot further in this "
                    "telenovela.</p>"
                    "<p><b>Updated: Agenda Alerts Now Identify the Merger</b><br>"
                    "When a voting meeting agenda is published, your alert will "
                    "now explicitly indicate whether A2507016 appears on it.</p>"
                    "<p>The ALJ decision and comment window is key. A decision "
                    "would have to come in the next 2-3 weeks to make the agenda "
                    "for the August meeting. If not, it will come down to the "
                    "September meeting — a sudden death scenario given the DOJ "
                    "antitrust clearance deadline is September 15.</p>"
