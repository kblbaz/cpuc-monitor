        ...
        try:
            send_email(
                ...
                (
                    ...
                    "is needed. Here's what this service does and what you'll "
                    "receive.\n\n"
                    "What This Is\n"
                    "The CPUC Meeting Monitor automatically watches the "
                    "California Public Utilities Commission (CPUC) — the state "
                    "agency that regulates utilities — and emails you when key "
                    "documents are published, so you don't have to check the "
                    "website yourself. It follows two things: (1) the CPUC's "
                    "upcoming voting meetings, and (2) the Charter Communications "
                    "/ Cox merger (CPUC proceeding A2507016).\n\n"
                    "What You'll Receive\n"
                    "You may receive up to three kinds of alerts:\n\n"
                    ...
                    "later meeting.\n\n"
                    "3) CHARTER/COX MERGER — PROPOSED DECISION\n"
                    ...
                    "You'll get a separate alert if a Commissioner files an "
                    "Alternate Proposed Decision — a competing version that "
                    "proposes a different outcome.\n"
                    "These alerts also include a plain-language \"What Happens "
                    "Next\" timeline: the public comment period, the reply-"
                    "comment period, the earliest date the matter can be placed "
                    "on a voting agenda, and which upcoming voting meeting is "
                ...
                html_body=(
                    ...
                    "you — no action is needed. Here's what this service does and "
                    "what you'll receive.</p>"
                    "<p><u>What This Is</u></p>"
                    "<p>The CPUC Meeting Monitor automatically watches the "
                    "<b>California Public Utilities Commission (CPUC)</b> — the "
                    "state agency that regulates utilities — and emails you when "
                    "key documents are published, so you don't have to check the "
                    "website yourself. It follows two things: (1) the CPUC's "
                    "upcoming <b>voting meetings</b>, and (2) the <b>Charter "
                    "Communications / Cox merger</b> (CPUC proceeding "
                    "A2507016).</p>"
                    "<p><u>What You'll Receive</u></p>"
                    "<p>You may receive up to three kinds of alerts:</p>"
                    ...
                    "were scheduled for a vote but have been postponed to a "
                    "later meeting.</p>"
                    "<p><b>3. Charter/Cox Merger — Proposed Decision</b><br>"
                    "Sent when a Proposed Decision is issued in the Charter/Cox "
                    "merger (A2507016). A Proposed Decision is the assigned "
                    "Administrative Law Judge's (ALJ's) recommended outcome, "
                    "published for public comment before the Commissioners vote. "
                    "You'll get a separate alert if a Commissioner files an "
                    "<b>Alternate Proposed Decision</b> — a competing version "
                    "that proposes a different outcome.<br>"
                    "These alerts also include a plain-language <b>\"What Happens "
                    "Next\"</b> timeline: the public comment period, the reply-"
                    "comment period, the earliest date the matter can be placed "
                    "on a voting agenda, and which upcoming voting meeting is "
