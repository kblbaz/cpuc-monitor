        ...
        try:
            send_email(
                ...
                (
                    ...
                    "domino that has to fall before anything else — which makes "
                    "it the earliest reliable signal of when a vote can actually "
                    "happen.\n\n"
                    "So your CPUC Meeting Monitor now watches for it. Here's "
                    "what's new:\n\n"
                    ...
                    "outcome — and nothing can be scheduled for a vote until it "
                    "lands and its comment periods run. It's the starting "
                    "gun.\n\n"
                    "...And a \"What Happens Next\" Timeline\n"
                    "This is the good part. The moment that Proposed Decision "
                    "drops, the clock starts — and each alert reads the document "
                    "and lays out what happens next: the public "
                ...
                html_body=(
                    ...
                    "first</b>. That one document is the domino that has to fall "
                    "before anything else — which makes it the earliest reliable "
                    "signal of when a vote can actually happen.</p>"
                    "<p>So your CPUC Meeting Monitor now watches for it. Here's "
                    "what's new:</p>"
